 ...
 *
 * Ideally this route could be expressed 
 * /:queue/:start..:end
 *
 * The regular expression is not yet correct. It's adapted from
 * an example in the express guide. It gets the test to pass
 * but the params are optional. 
 *
 * Is there a better way to destructure req.params?
 */
